...
//Q6
 ...
 var myFavoriteAnimals = ['cat', 'dog', 'bunny', 'lion'];
 console.log(myFavoriteAnimals);
 myFavoriteAnimals = ['cat', 'dog', 'bunny', 'lion', 'Daans' ];
 console.log(myFavoriteAnimals);
 ...
 console.log("The value's of my variables are string and integer ");
...
var num = 7;
var percentSign = num % 3;
console.log(percentSign);
console.log("This sign means that the numbers when you divide them by another number the rest would be 1 or more");
